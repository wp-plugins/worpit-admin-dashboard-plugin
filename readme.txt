...
* Added enhanced logging of errors when an attempt is made to link a site to Worpit.

= 1.0.1 =

* Updates to the plugin mechanism that works around system that don't allow exec()
